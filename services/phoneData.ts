...
export const MOCK_PHONES: Phone[] = [
  {
    ...
    features: ['Best Camera', 'OIS', 'Clean Android', 'AI Features', '7 years updates'],
  ...
  },
  {
    ...
    features: ['Flagship Camera', 'OIS', 'Compact', 'AI Eraser'],
  ...
  },
  {
    ...
    features: ['Dynamic Island', 'OIS', 'Great Video', 'Ecosystem', 'Resale Value'],
  ...
  },
  {
    ...
    features: ['Battery King', 'OIS', 'Fast Charging', 'Gaming Performance'],
  ...
  },
  {
    ...
    features: ['Telephoto Lens', 'OIS', 'Wireless Charging', 'IP68 Rating'],
  ...
  },
  {
    ...
    features: ['Unique Design', 'OIS', 'Glyph Interface', 'Clean Software'],
  ...
  },
  {
    ...
    features: ['Pantone Validated Display', 'OIS', '125W Charging', 'Wireless Charging'],
  ...
  },
  {
    ...
    features: ['200MP Camera', 'OIS', 'IP68 Rating', 'Curved Display'],
  ...
  },
  {
    ...
    features: ['Gaming Performance', 'OIS', 'Best Value', 'Fast Storage'],
  ...
  },
  {
    ...
    features: ['Flagship Processor', 'OIS', 'Gaming Chip', 'Fast Charging'],
